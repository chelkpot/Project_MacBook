...
## Внимание  колнировать этот репозитарий не следует. Пушить только в свой личный аккаунт на гитхабе.
- 1. Скачайте папку images и поместите ее в свой проект
- 2. Наберите в корне вашегоо проекта git init
- 3. Создайте файл index.html и подключите к нему style.css
- 4. Закомитьте ваш проетк git add, git commit
